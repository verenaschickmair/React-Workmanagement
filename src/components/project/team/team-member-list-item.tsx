...
export const TeamMemberItem = ({person,isSelected=false}:TeamMemberItemProps) => {
    ...
    const onItemClick = (member:TeamMemberData) => {
        ...
        if(!selectedState){
            ...
            setSelectedTeamMembers(selectedTeamMembers.filter(person => person != member))
        }
    }
    const defaultClasses = "group flex w-full items-center justify-between space-x-3 rounded-full border border-gray-300 p-2 text-left shadow-sm hover:bg-gray-50"
