    ...
    return(
        <Fragment>
            ...
            Create a new project
                ...
                <CustomInputField idTag="project-name" type="text"  onChange={onInputChange}
                    value={projectName}  placeholder="Enter the project name"/>
                </form>
                <TeamMember/>
                <CustomButton onClick={onButtonCreateClick} buttonText="Create Project" style={({marginTop: '20px'})}/>
        </Fragment>
    )
}